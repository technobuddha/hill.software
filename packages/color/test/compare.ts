    ...
    () => {
        test(
            ...
            () => {
                ...
                expect(color.colorDistance(color1, color2)).toBeCloseTo(175.4962545535185);
            }
        );
        ...
        test(
            ...
            () => {
                const color1 = { l: 36, a: 60, b: 41 };
                const color2 = { l: 55, a: 66, b: 77 };
                expect(color.deltaC(color1, color2)).toBeCloseTo(28.744499834125108);
            }
        );
        ...
        test(
            ...
            () => {
                const color1 = { l: 36, a: 60, b: 41 };
                const color2 = { l: 55, a: 66, b: 77 };
                expect(color.deltaH(color1, color2)).toBeCloseTo(22.48896905787327);
            }
        );
        ...
        test(
            ...
            () => {
                const color1 = { l: 36, a: 60, b: 41 };
                const color2 = { l: 55, a: 66, b: 77 };
                expect(color.deltaCMC(color1, color2)).toBeCloseTo(27.5055471447253);
            }
        );
        ...
        test(
            'deltaCMC',
            () => {
                const color1 = { r: 55, g: 60, b: 48 };
                const color2 = { r: 55, g: 65, b: 53 };
                expect(color.deltaCMC(color1, color2)).toBeCloseTo(3.5905910602807696);
            }
        );
        ...
        test(
            'deltaCMC',
            () => {
                const color1 = { l: 50, a: 40, b: 20 };
                const color2 = { l: 60, a: 20, b: 100 };
                expect(color.deltaCMC(color1, color2)).toBeCloseTo(50.91322671406770);
            }
        );
        ...
        test(
            'deltaCMC',
            () => {
                const color1 = { l: 10, a: -72, b: 0 };
                const color2 = { l: 60, a:  20, b: 100 };
                expect(color.deltaCMC(color1, color2)).toBeCloseTo(114.4006964443775);
            }
        );
