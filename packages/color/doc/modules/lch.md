...
[lch.ts:126](../../src/lch.ts#L126)

## Functions

### external

▸ **external**(`__namedParameters`): [`LCH`](lch.md#lch)
...
[lch.ts:25](../../src/lch.ts#L25)

___

### internal

▸ **internal**(`color`): `internalLCH`
...
[lch.ts:19](../../src/lch.ts#L19)

___

### is

▸ **is**(`color`): color is partialLCH
...
[lch.ts:14](../../src/lch.ts#L14)

___

### parse

▸ **parse**(`input`): [`LCH`](lch.md#lch) \| `undefined`
...
[`LCH`](lch.md#lch) \| `undefined`

#### Defined in

[lch.ts:88](../../src/lch.ts#L88)
