...
[xyz.ts:162](../../src/xyz.ts#L162)

## Functions

### external

▸ **external**(`__namedParameters`): [`XYZ`](xyz.md#xyz)
...
[xyz.ts:26](../../src/xyz.ts#L26)

___

### internal

▸ **internal**(`color`): `internalXYZ`
...
[xyz.ts:20](../../src/xyz.ts#L20)

___

### is

▸ **is**(`color`): color is partialXYZ
...
[xyz.ts:15](../../src/xyz.ts#L15)

___

### parse

▸ **parse**(`input`): [`XYZ`](xyz.md#xyz) \| `undefined`
...
[`XYZ`](xyz.md#xyz) \| `undefined`

#### Defined in

[xyz.ts:121](../../src/xyz.ts#L121)
