...
import rendererFactory          from './columnFactory/rendererFactory';
import headerFactory            from './columnFactory/headerFactory';
import collatorFactory          from './columnFactory/collatorFactory';
...
function analyze<T = unknown>(data: T[], columns?: ColumnSpecifications<T>): {types: Record<string, ColumnType>, shape: Shape} {
