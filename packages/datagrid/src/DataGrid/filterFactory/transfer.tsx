...
export function filterFactoryTransfer<T = unknown>({name, title, Icon}: FilterFactoryTransferOptions, { getShape }: AnalyzerResults<T>): Filter<T> {
    return {
        name,
...
export default filterFactoryTransfer;
