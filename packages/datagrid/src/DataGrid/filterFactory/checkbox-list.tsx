...
export function filterFactoryCheckbox<T = unknown>({name, title, Icon}: FilterFactoryCheckboxOptions, data: T[], { getShape }: AnalyzerResults<T>): Filter<T> {
...
export default filterFactoryCheckbox;
