...
export function filterFactorySearch<T = unknown>({name, title}: FilterFactorySearchOptions, { getShape }: AnalyzerResults<T>): Filter<T> {
    return {
        name,
        Actuator:  () => {
        ...
        Indicator() {   //TODO I should be able to omit this
            return null;
        },
